...
class BannerAdmin(admin.ModelAdmin):
    list_display = ('title','event','description','small_image',' large_image','order')
admin.site.register(Banner,BannerAdmin) 

class EventTicketAdmin(admin.ModelAdmin):
    list_display = ('event','payment_status','attandance','email','phone','full_name','phone_code','address',' district')
